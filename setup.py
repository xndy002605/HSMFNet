...
cfg_file = os.path.join('configs', 'visual_FGSCR42.yaml')#_FGSCR42
...
#config.model.pretrained = os.path.join(config.model.pretrained,config.model.name + config.model.pre_version + config.model.pre_suffix)
