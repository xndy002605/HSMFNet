...
_C.model.pretrained_model = False
...
# -----------------------------------------------------------------------------
_C.parameters = CN()
_C.parameters.enh_TPFE = False
_C.parameters.head_drop = 0.
_C.parameters.top_ratio = 0.
_C.parameters.cross_layer = False
_C.parameters.agg_channel_num = 1
_C.parameters.focal_loss_alpha = []
_C.parameters.fine2coarse = []
_C.parameters.enh_head = True
_C.parameters.pos = True
_C.parameters.m = 16
_C.parameters.use_mha = True
_C.parameters.num_heads = 16
_C.parameters.att_drop = 0.2
_C.parameters.backbone_low_lr= False
_C.parameters.sc = False
_C.parameters.st = False
